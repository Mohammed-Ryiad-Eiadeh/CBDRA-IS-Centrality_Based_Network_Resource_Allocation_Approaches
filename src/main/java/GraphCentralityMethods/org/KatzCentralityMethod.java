...
public class KatzCentralityMethod {
    ...
    /**
     * This constructor is used to initialize the adjacency matrix that is going to be passed to katz centrality
    ...
    public HashMap<Integer, Double> getScores() {
        ...
        KatzCentrality<Integer, DefaultWeightedEdge> katzCentrality = new KatzCentrality<>(graph, 0.01, 100, 0.0001);
